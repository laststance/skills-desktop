...
describe('findEmptySpot', () => {
  test('drops the first widget into the top-left corner of an empty page', () => {
    // Arrange
  ...
  test('stacks a new full-width widget on the row below an existing one', () => {
    // Arrange
  ...
  test('packs a small widget beside a half-width one on the same row', () => {
  ...
  test('refuses to place a widget once the page already holds MAX_WIDGETS_PER_PAGE', () => {
  ...
  test('refuses to place a widget wider than the grid itself', () => {
  ...
  test('returns null when one widget fills every searchable row so no spot is left', () => {
