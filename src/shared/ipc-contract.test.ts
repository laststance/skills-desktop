...
describe('IPC contract alignment', () => {
  it('forces a security review by tripping when an invoke channel is added or removed', () => {
    ...
    const invokeMapping = {
      ...
      [IPC_CHANNELS.AGENTS_REMOVE_EMPTY_FOLDER]: true,
      ...
      [IPC_CHANNELS.SKILLS_LOCK_SCAN_STALE]: true,
      [IPC_CHANNELS.SKILLS_LOCK_PRUNE]: true,
    ...
    // Assert
    expect(invokeChannelKeys).toHaveLength(49)
  })
