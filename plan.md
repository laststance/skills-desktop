...
- Apply accepted by Main continues after Settings closes. A newer accepted selection or Clear supersedes an older pending selection. Closing a window differs from quitting the application: unfinished work is not resumed automatically after process exit.
