...
| A2 · P1 · 9/10 | `src/main/services/fileReader.ts:217` checks a 5 MiB limit and extension-based MIME; Sharp is a dev dependency in `package.json:103`     | Promote installed Sharp to a production dependency for background ingestion. Keep the skill-image reader's existing boundary.  |
...
- Combined QA (baseline + follow-up): `/Users/ryotamurakami/.gstack/projects/laststance-skills-desktop/ryotamurakami-codex-background-image-trials-eng-review-test-plan-20260908-013350.md`.
...
- Design tasks: `/Users/ryotamurakami/.gstack/projects/laststance-skills-desktop/tasks-design-review-20260908-010813.jsonl` (5).
- Engineering follow-up tasks: `/Users/ryotamurakami/.gstack/projects/laststance-skills-desktop/tasks-eng-review-20260908-013350.jsonl` (3).
