          ...
          <div className="relative p-8 sm:p-12 lg:p-16">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                <a
                  href="https://github.com/laststance/skills-desktop/releases/download/v0.18.1/skills-desktop-0.18.1-arm64.dmg"
                ...
                <a
                  href="https://github.com/laststance/skills-desktop/releases/download/v0.18.1/skills-desktop-0.18.1-x64.dmg"
