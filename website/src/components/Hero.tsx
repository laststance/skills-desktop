      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <a
              href="https://github.com/laststance/skills-desktop/releases/download/v0.9.0/skills-desktop-0.9.0-arm64.dmg"
            ...
            <a
              href="https://github.com/laststance/skills-desktop/releases/download/v0.9.0/skills-desktop-0.9.0-x64.dmg"
