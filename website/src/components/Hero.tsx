      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <a
              href="https://github.com/laststance/skills-desktop/releases/download/v0.31.2/skills-desktop-0.31.2-arm64.dmg"
            ...
            <a
              href="https://github.com/laststance/skills-desktop/releases/download/v0.31.2/skills-desktop-0.31.2-x64.dmg"
